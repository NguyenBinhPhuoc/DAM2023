    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <?php if (!empty($image)) echo '<img style="height: 80px; width: 80px; object-fit: cover;     border-radius: 10px; margin-top: 5px;" src="' . $image . '" alt="">'; ?>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control" id="intro" cols="30" rows="12"><?php echo set_value('description') ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label for="intro">Chi tiết sản phẩm</label>
                    <textarea name="detail" class="form-control" id="intro" cols="30" rows="5"><?php echo set_value('detail') ?></textarea>
                </div>
                <div class="form-group">
                ...
                <input type="submit" name="add_product" class="btn btn-primary" value="Chỉnh sửa">
            </form>
            <span>
